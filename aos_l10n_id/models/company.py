...
#                                          ('08','08 Tanpa PPN')], compute='_compute_address', inverse='_inverse_code_transc', string='Kode Transaksi')
    ...
    def _get_company_address_update(self, partner):
        ...
        vals['blok'] = partner.blok
        vals['nomor'] = partner.nomor
        vals['rt'] = partner.rt
        vals['rw'] = partner.rw
        vals['kelurahan_id'] = partner.kelurahan_id
        vals['kecamatan_id'] = partner.kecamatan_id
        vals['kabupaten_id'] = partner.kabupaten_id
        return vals
#         return {
