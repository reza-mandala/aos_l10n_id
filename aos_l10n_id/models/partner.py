...
class res_partner(models.Model):
    ...
    blok = fields.Char('Blok', size=8, ondelete='restrict')
    nomor = fields.Char('Nomor', size=8, ondelete='restrict')
    rt = fields.Char('RT', size=3, ondelete='restrict')
    rw = fields.Char('RW', size=3, ondelete='restrict')
    kelurahan_id = fields.Many2one('res.kelurahan', string="Kelurahan", ondelete='restrict')
    kecamatan_id = fields.Many2one('res.kecamatan', string="Kecamatan", ondelete='restrict')
    kabupaten_id = fields.Many2one('res.kabupaten', string="Kabupaten", ondelete='restrict')
